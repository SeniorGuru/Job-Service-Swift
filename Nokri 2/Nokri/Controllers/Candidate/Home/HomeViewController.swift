...
//            }
            ...
            //cell.lblJobType.backgroundColor = UIColor(hex: appColorNew!)
           ...
           // cell.btnCompanyDetail.addTarget(self, action: #selector(HomeViewController.nokri_btnCompanyDetailClicked(_:)), for: .touchUpInside)
