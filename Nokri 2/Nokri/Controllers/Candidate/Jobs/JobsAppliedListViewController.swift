//
//  JobsAppliedListViewController.swift
//  Opportunities
//
...
class JobsAppliedListViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "JobsAppliedListTableViewCell", for: indexPath) as! JobsAppliedListTableViewCell
       // cell.lblPartOrFullTime.layer.borderColor = UIColor(hex:"1DA3F4").cgColor
       // cell.lblPartOrFullTime.layer.cornerRadius = 10
        ...
        cell.btnCompanyDetail.addTarget(self, action:  #selector(JobsAppliedListViewController.nokri_btnCompanyDetailClicked), for: .touchUpInside)
        cell.btnJobDetail.addTarget(self, action:  #selector(JobsAppliedListViewController.nokri_btnJobDetailClicked), for: .touchUpInside)
...
//                    SwiftyAd.shared.showInterstitial(from: self)
    ...
    @IBAction func btnLoadMoreClicked(_ sender: UIButton) {
        if hasNextPage == true{
           nokri_jobAppliedDataPagination()
        }
    }
    ...
    func nokri_jobAppliedData(){
        ...
        if UserDefaults.standard.bool(forKey: "isSocial") == true {
            ...
            Alamofire.request(Constants.URL.baseUrl+Constants.URL.appliedJobs, method: .post, parameters: param, encoding: JSONEncoding.default, headers: headers)
    ...
    func nokri_jobAppliedDataPagination(){
