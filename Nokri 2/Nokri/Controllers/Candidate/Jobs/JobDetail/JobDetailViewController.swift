...
class JobDetailViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,WKNavigationDelegate {
    ...
    func nokri_populateData(){
        ...
        for obj in extraArr{
            ...
            if obj.fieldTypeName == "job_apply"{
                ...
                self.btnApplyNow.setTitle(obj.key, for: .normal)
    ...
    func nokri_viewJob() {
        ...
        UserHandler.nokri_viewJob(parameter: params as NSDictionary, success: { (successResponse) in
            ...
            if successResponse.success == true{
                ...
                //                for ob in self.extraArr{
                //                    if ob.isjobApplyAllow == true{
                //                        self.isWithOutLoginApply = true
                //                        self.emailPlace = ob.emailPlace
                //                        self.namePlace = ob.namePlace
                //                    }
                //                }
