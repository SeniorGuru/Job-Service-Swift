...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell.lblPartOrFullTime.layer.borderWidth = 1
        //cell.lblPartOrFullTime.layer.borderColor = UIColor(hex:appColorNew!).cgColor
...
//        if tableView.isDragging {
//            //cell.transform = CGAffineTransform.init(scaleX: 0.5, y: 0.5)
//            cell.transform = CGAffineTransform.init(rotationAngle: 2.0)
//
...
//                    SwiftyAd.shared.showInterstitial(from: self)
    ...
    func nokri_allJobsData(){
        ...
        if UserDefaults.standard.bool(forKey: "isSocial") == true {
            ...
            print(param)
            Alamofire.request(Constants.URL.baseUrl+Constants.URL.allJobs, method: .post, parameters: param, encoding: JSONEncoding.default, headers: headers)
