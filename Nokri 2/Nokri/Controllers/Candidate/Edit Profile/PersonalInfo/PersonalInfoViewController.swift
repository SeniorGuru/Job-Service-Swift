            ...
            Alamofire.request(Constants.URL.baseUrl+Constants.URL.canPersonalInfo, method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers)
                .responseJSON { response in
                    ...
                    if success == true{
                        ...
                        //self.txtLastEducation.text = self.lastEduArray[0]
                        //self.txtType.text = self.typeArray[0]
                        //self.txtLevel.text = self.levelArray[0]
                        //self.txtExperience.text = self.experienceArray[0]
                        //self.txtSetProValue.text = self.setProArrayVal[0]
                    }else{
                        //self.tableView.isHidden = true
