...
class DashboardCompanyViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
                    ...
                    if field_type_name == "about_me" {
                        if let value = innerDict["value"] as? String {
                            if value != ""{
                                ...
                                //                            cell.lblAboutCompany.attributedText = attrStr
...
//                                    documentAttributes: nil)
//                                cell.lblAboutCompany.attributedText = attrStr
//                                self.aboutCellHeight = (cell.lblAboutCompany.attributedText?.height(withConstrainedWidth: self.view.frame.size.width))!+40;
                            }else{
            ...
            //
            ////            let objData = dataArraySkills[indexPath.row]
            ////
            //            let cell = tableView.dequeueReusableCell(withIdentifier: "DashboardCandidateSkillTableViewCell", for: indexPath) as! DashboardCandidateSkillTableViewCell
            ////
            ////            cell.lblSkill.text = objData.value
            //
            //            return cell
            //
            //        }
...
//                        if let value = innerDict["value"] as? String {
//                            //cell.btnDeleteAccount.setTitle(value, for: .normal)
//                        }
                    }
                }
            }
            //cell.btnDeleteAccount.addTarget(self, action: #selector(DashboardCompanyViewController.nokri_btnDeleteAccClicked(_:)), for: .touchUpInside)
            //MARKL:- Map
            ...
            //cell.btnDeleteAccount.addTarget(self, action:
              //#selector(DashboarCompanyViewController.nokri_btnDeleteAccClicked(_:)), for: .touchUpInside)
            return cell
        }
    }
    /*
...
//            let passwordNew = KeychainService.loadPassword()
//            print(passwordNew!)
//
            if let userEmail = UserDefaults.standard.string(forKey: "email") {
                email = userEmail
