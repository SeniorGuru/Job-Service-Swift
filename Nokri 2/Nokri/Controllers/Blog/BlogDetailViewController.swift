...
class BlogDetailViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,tableHightDelegate {
    ...
    @IBAction func btnPublishClicked(_ sender: UIButton) {
        ...
        if withOutLogin == 5{
          ...
          //self.view.makeToast(extra?.publish.msg, duration: 1.5, position: .bottom)
        }else{
    ...
    func nokri_populateData(){
        if let image = URL(string: (post?.image)!){
            ...
            if Constants.isiPadDevice {
                ...
                //heightConstrainFullView.constant += 60
...
//            let data = WebTitle.data(using: String.Encoding.unicode)! // mind "!"
//            let attrStr = try? NSAttributedString( // do catch
//                data: data,
//                options: [NSAttributedString.DocumentReadingOptionKey.documentType: NSAttributedString.DocumentType.html],
//                documentAttributes: nil)
//            lblWebTitle.font = UIFont(name:"Montserrat-SemiBold",size:14)
//            lblWebTitle.attributedText = attrStr
...
//            ]
//            let data1 = WebTitle.data(using: String.Encoding.unicode)!
//            let attrStr = try? NSAttributedString(
//                data: data1,
//                options: [NSAttributedString.DocumentReadingOptionKey.documentType: NSAttributedString.DocumentType.html],
//                documentAttributes: nil)
...
//                documentAttributes: nil)
//
//            lblWeb.font = UIFont(name:"OpenSans",size:14)
//            lblWeb.attributedText = attrStr
//
//            let height = (lblWeb.attributedText?.height(withConstrainedWidth: self.view.frame.size.width))!;
//            lblWeb.frame.size.height
//                = height
