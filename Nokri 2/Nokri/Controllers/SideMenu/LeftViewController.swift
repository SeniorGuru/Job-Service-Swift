...
class LeftViewController : UIViewController, LeftMenuProtocol,LeftMenuProtocol2,LeftMenuProtocol3 {
   ...
   // var jobAlertController: UIViewController!
    ...
    func nokri_settngData() {
        if let userData = UserDefaults.standard.object(forKey: "settingsData") {
            ...
            menuIcons = [#imageLiteral(resourceName: "iconHome"),#imageLiteral(resourceName: "iconDashboard"),#imageLiteral(resourceName: "iconUpdateProfile"),#imageLiteral(resourceName: "myevents"),#imageLiteral(resourceName: "icomFollowers"),#imageLiteral(resourceName: "iconJobApplied"),#imageLiteral(resourceName: "iconBlog"),#imageLiteral(resourceName: "iconPackages"),#imageLiteral(resourceName: "iconPkgDetail"),#imageLiteral(resourceName: "settings"),#imageLiteral(resourceName: "iconLogout"),#imageLiteral(resourceName: "iconExit")]
            ...
            menuIconsCompany = [#imageLiteral(resourceName: "iconHome"),#imageLiteral(resourceName: "iconDashboard"),#imageLiteral(resourceName: "iconUpdateProfile"),#imageLiteral(resourceName: "iconMsg"),#imageLiteral(resourceName: "myevents"),#imageLiteral(resourceName: "ticket"),#imageLiteral(resourceName: "iconPackages"),#imageLiteral(resourceName: "iconPkgDetail"),#imageLiteral(resourceName: "iconBlog"),#imageLiteral(resourceName: "settings"),#imageLiteral(resourceName: "iconSignIn"),#imageLiteral(resourceName: "iconLogout"),#imageLiteral(resourceName: "iconExit")]
    ...
    func changeViewController2(_ menu2: LeftMenu2) {
        ...
        if withOutLogin == "5"{
            ...
            case.signUp:
                appDelegate.nokri_moveToSignUp()
            //case .faq:
              //  appDelegate.nokri_moveToFaqs()
            case .setting:
                appDelegate.nokri_moveToSetting()
    ...
    func changeViewController3(_ menu3: LeftMenu3) {
        ...
        if withOutLogin != "5"{
            ...
            // aType = Int(accountTypeFromFb!)!
            //ca-app-pub-5436643862950256~3079537568
            //ca-app-pub-5436643862950256/2661283902
            let check = UserDefaults.standard.string(forKey: "loginCheck")
...
extension LeftViewController : UITableViewDelegate {
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if let menu = LeftMenu(rawValue: indexPath.row) {
            switch menu {
            case .home,.dashBoard,.editProfile,/*.myProfile,.myResumes,*/.jobs,.jobsApplied,/*.jobsForYou,*/.savedJobs,/*.advanceSearch,.employerSearch,.candidateSearch.followedCompanies,.jobNotification,.jobAlert,*/.candPkg,.candPkgDetail,.bloged,/*.faq,*/.setting,.logouT,.exit:
        ...
        if let menu = LeftMenu2(rawValue: indexPath.row) {
            switch menu {
            case .home,/*.explrore,.canSearch,*/.blogg,.signUp,.sighIn,/*.faq,*/.setting,.Exit:
                return BaseTableViewCell.height()
            }
        }
        ...
        if let menu = LeftMenu3(rawValue: indexPath.row) {
            switch menu {
            case .home,.dashBoard,.editProfile,.emailTemp,.job,/*.follower,.matchResume,.saveResume,*/.jobPost,.PackageDetail,.package,.blog,/*.canSearch,.employerSearch,.faq*,*/.setting,.logout,.exit:
                return BaseTableViewCell.height()
            }
        }
