//
//  EmployerSearchedViewController.swift
//  Nokri
//
...
class EmployerSearchedViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell  = tableView.dequeueReusableCell(withIdentifier: "EmployerSearchedTableViewCell", for: indexPath) as! EmployerSearchedTableViewCell
