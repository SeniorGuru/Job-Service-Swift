//
//  JobCatFourViewController.swift
//  Nokri
//
...
class JobCatFourViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "JobCatFourTableViewCell", for: indexPath) as! JobCatFourTableViewCell
    ...
    @objc func btnNext(sender: UIButton!){
         ...
         UserDefaults.standard.set(sender.tag, forKey:"ca4Key")
