//
//  JobPostStateViewController.swift
//  Nokri
//
...
class JobPostStateViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "JobPostStateTableViewCell", for: indexPath) as! JobPostStateTableViewCell
        ...
        cell.btnNext.addTarget(self, action: #selector(JobPostStateViewController.btnNext), for: .touchUpInside)
        return cell
    }
    ...
    @objc func btnNext(sender: UIButton!){
        UserDefaults.standard.set(sender.tag, forKey:"co2Key")
        if sender.currentTitle == "false"{
            ...
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "JobPostCityViewController") as? JobPostCityViewController
            vc?.key = sender.tag
