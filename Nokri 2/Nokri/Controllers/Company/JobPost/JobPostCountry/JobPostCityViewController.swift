//
//  JobPostCityViewController.swift
//  Nokri
//
...
class JobPostCityViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
        ...
        @IBOutlet weak var tableView: UITableView!
         ...
         var jobSubCatArrat = NSMutableArray()
           ...
           func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
               ...
               let cell = tableView.dequeueReusableCell(withIdentifier: "JobPostCityTableViewCell", for: indexPath) as! JobPostCityTableViewCell
         ...
         @objc func btnNext(sender: UIButton!){
              ...
              UserDefaults.standard.set(sender.tag, forKey:"co3Key")
