...
struct ViewJobExtra{
    ...
    var key : String!
    var value : String!
    var isjobApplyAllow : Bool!
    var namePlace : String!
    var emailPlace : String!
    /**
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        isjobApplyAllow = dictionary["apply"] as? Bool
        namePlace = dictionary["cand_name"] as? String
        emailPlace = dictionary["cand_email"] as? String
    }
